...
data class ReaderPrefs(val version:String="rv1909",val fontSize:Int=20,val theme:String="sepia",val pageMode:Boolean=true,val book:String="GEN",val chapter:Int=1)
class PreferencesRepository(private val context:Context){
 ...
 val flow=context.ds.data.map{ReaderPrefs(it[K.version]?:"rv1909",it[K.font]?:20,it[K.theme]?:"sepia",it[K.page]?:true,it[K.book]?:"GEN",it[K.chapter]?:1)}
